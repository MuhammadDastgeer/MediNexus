    ...
    <div className="p-4 sm:p-6 h-full overflow-y-auto select-none space-y-6 bg-[#f8fafc]/90" id="doctors-unified-view">
      ...
      {!showForm && (
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-2">
          {/* Pills Tabs Switch */}
          {!isPatient ? (
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit gap-1" id="doctors-tabs-container">
              <button
                onClick={() => setActiveTab('overview')}
                className={`flex items-center gap-2 px-4.5 py-2 text-xs font-bold rounded-xl transition-all cursor-pointer active:scale-95 ${
                  activeTab === 'overview'
